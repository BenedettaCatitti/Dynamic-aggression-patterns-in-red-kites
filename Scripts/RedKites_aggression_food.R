...
peck_tot <- read_csv("./Data/peck_tot.csv") 
...
table_early_h <- table_tot %>% filter(phase == "early" , food_cat == "high") %>%
...
table_early_m <- table_tot %>% filter(phase == "early" , food_cat == "medium") %>%
                  arrange(match(direction, c("AB", "BA", "BC", "CB","AC","CA")))
...
table_early_l <- table_tot %>% filter(phase == "early" , food_cat == "low") %>%
                  arrange(match(direction, c("AB", "BA", "BC", "CB","AC","CA")))
...
table_late_h <- table_tot %>% filter(phase == "late" , food_cat == "high") %>%
  arrange(match(direction, c("AB", "BA", "BC", "CB","AC","CA")))
...
table_late_m <- table_tot %>% filter(phase == "late" , food_cat == "medium") %>%
  arrange(match(direction, c("AB", "BA", "BC", "CB","AC","CA")))
...
table_late_l <- table_tot %>% filter(phase == "late" , food_cat == "low") %>%
  arrange(match(direction, c("AB", "BA", "BC", "CB","AC","CA")))
